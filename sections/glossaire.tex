...
\newacronym{baltik}{BALTIK}{Building Applications Linked with TRUST Kernels}
...
\newacronym{lcan}{LCAN}{Laboratoire de Calcul Intensif et d'Analise Numérique}
...
\newglossaryentry{trust}{
  name={TRUST},
  description={TRioU Software for Thermohydraulics - logiciel open-source de thermohydraulique développé par le CEA}
}
